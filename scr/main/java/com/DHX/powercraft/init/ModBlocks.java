...
public class ModBlocks
  {
    ...
    public static void init()
    {
      ...
      GameRegistry.registerBlock((new BlockZGFarmland()).setHardness(0.6F).setStepSound(Block.soundTypeGravel).setBlockName(String.format(Reference.MOD_ID.toLowerCase() + ":blockzgfarmland")).setBlockTextureName("farmland"), "blockzgfarmland");
